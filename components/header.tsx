    ...
    >
      <nav className="container-padding mx-auto flex h-16 items-center justify-between">
          ...
          <Link href="/" className="-m-1.5 p-1.5 relative">
            ...
            <div className="relative z-10">
              <Image
                ...
                width={150}
                height={50}
                className="h-14 w-auto relative z-10 dark:drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]"
              />
            </div>
          </Link>
        </div>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:gap-x-4">
          ...
          <Button
            asChild
            className="bg-sulkar-green text-white hover:bg-sulkar-green/90 dark:bg-sulkar-green dark:text-white dark:hover:bg-sulkar-green/90"
          >
            <Link href="/contratacion">Contratación Pública</Link>
          </Button>
        </div>
      </nav>
