        ...
        <div className="container-padding mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <p>
              ...
              exclusiva de los tribunales de Bogotá, Colombia.
            </p>
            ...
            <ul>
              <li>Por correo electrónico: info@sulkar.com</li>
              <li>Por teléfono: +57 (1) 123-4567</li>
              <li>Por correo postal: Calle Principal #123, Bogotá, Colombia</li>
            </ul>

            <p className="text-sm text-gray-500 dark:text-gray-400 mt-8">Última actualización: 29 de abril de 2023</p>
          </div>
        </div>
      </section>
    </div>
